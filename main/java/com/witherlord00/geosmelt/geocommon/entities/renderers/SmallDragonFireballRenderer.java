...
@OnlyIn(Dist.CLIENT)
public class SmallDragonFireballRenderer extends EntityRenderer<SmallDragonFireballEntity> {
   private static final ResourceLocation SMALL_DRAGON_FIREBALL_TEXTURE = new ResourceLocation("geosmelt:textures/entity/small_dragon_fireball.png");
   private static final RenderType field_229044_e_ = RenderType.getEntityCutoutNoCull(SMALL_DRAGON_FIREBALL_TEXTURE);

   public SmallDragonFireballRenderer(EntityRendererManager renderManagerIn) {
      super(renderManagerIn);
   }

   protected int getBlockLight(SmallDragonFireballEntity entityIn, BlockPos partialTicks) {
      return 15;
   }

   public void render(SmallDragonFireballEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      matrixStackIn.push();
    ...
    */
   public ResourceLocation getEntityTexture(SmallDragonFireballEntity entity) {
      return SMALL_DRAGON_FIREBALL_TEXTURE;
   }
}
