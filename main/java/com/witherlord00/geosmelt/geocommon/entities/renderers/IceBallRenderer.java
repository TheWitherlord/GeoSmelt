...
public class IceBallRenderer extends EntityRenderer<IceBallEntity> {
   private static final ResourceLocation ICE_BALL_TEXTURE = new ResourceLocation("geosmelt:textures/entity/ice_ball.png");
   private static final RenderType field_229044_e_ = RenderType.getEntityCutoutNoCull(ICE_BALL_TEXTURE);

   public IceBallRenderer(EntityRendererManager renderManagerIn) {
      super(renderManagerIn);
   }

   protected int getBlockLight(IceBallEntity entityIn, BlockPos partialTicks) {
      return 15;
   }

   public void render(IceBallEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      matrixStackIn.push();
    ...
    */
   public ResourceLocation getEntityTexture(IceBallEntity entity) {
      return ICE_BALL_TEXTURE;
   }
}
