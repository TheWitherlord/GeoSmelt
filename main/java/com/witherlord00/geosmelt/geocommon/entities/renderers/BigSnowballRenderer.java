...
@OnlyIn(Dist.CLIENT)
public class BigSnowballRenderer extends EntityRenderer<BigSnowballEntity> {
   private static final ResourceLocation SNOW_BALL_TEXTURE = new ResourceLocation("geosmelt:textures/entity/snow_ball.png");
   private static final RenderType field_229044_e_ = RenderType.getEntityCutoutNoCull(SNOW_BALL_TEXTURE);

   public BigSnowballRenderer(EntityRendererManager renderManagerIn) {
      super(renderManagerIn);
   }

   protected int getBlockLight(BigSnowballEntity entityIn, BlockPos partialTicks) {
      return 0;
   }

   public void render(BigSnowballEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      matrixStackIn.push();
    ...
    */
   public ResourceLocation getEntityTexture(BigSnowballEntity entity) {
      return SNOW_BALL_TEXTURE;
   }
}
