...
public class GreaterFireTome extends Item {

	public GreaterFireTome(Properties properties) {
		super(properties);
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand hand) {
		...
		if (!itemstack.isEmpty() || flag) {
			...
			FireballEntity charge = new FireballEntity(worldIn, playerIn, d2, d3, d4);
