...
@OnlyIn(Dist.CLIENT)
public class HolyOrbRenderer extends EntityRenderer<HolyOrbEntity> {
   private static final ResourceLocation HOLY_ORB_TEXTURE = new ResourceLocation("geosmelt:textures/entity/holy_orb.png");
   private static final RenderType field_229044_e_ = RenderType.getEntityCutoutNoCull(HOLY_ORB_TEXTURE);

   public HolyOrbRenderer(EntityRendererManager renderManagerIn) {
      super(renderManagerIn);
   }

   protected int getBlockLight(HolyOrbEntity entityIn, BlockPos partialTicks) {
      return 15;
   }

   public void render(HolyOrbEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      matrixStackIn.push();
    ...
    */
   public ResourceLocation getEntityTexture(HolyOrbEntity entity) {
      return HOLY_ORB_TEXTURE;
   }
}
