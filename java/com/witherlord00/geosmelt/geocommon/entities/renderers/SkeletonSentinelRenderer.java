...
@OnlyIn(Dist.CLIENT)
public class SkeletonSentinelRenderer extends BipedRenderer<AbstractSkeletonEntity, SkeletonModel<AbstractSkeletonEntity>> { 
   ...
   public SkeletonSentinelRenderer(EntityRendererManager renderManagerIn) {
