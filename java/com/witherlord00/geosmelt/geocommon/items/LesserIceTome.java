...
public class LesserIceTome extends Item {

	
	public LesserIceTome(Properties properties) { 
		super(properties);
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand hand) {
		...
		if (!itemstack.isEmpty() || flag) {
			...
			IceBallEntity charge = new IceBallEntity( GeoEntityRegistry.ICE_BALL, worldIn, playerIn, d2, d3, d4);
			...
			playerIn.getCooldownTracker().setCooldown(this, 9);
	...
	public boolean isInfinite(ItemStack stack, ItemStack bow, net.minecraft.entity.player.PlayerEntity player) {
		...
		return enchant > 0 && stack.getItem() == Items.FIRE_CHARGE;
	}
