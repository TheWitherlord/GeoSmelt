...
public class HarmingStaffItem extends SwordItem { 

	public HarmingStaffItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, Properties builderIn) {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand hand) {
		...
		if (!itemstack.isEmpty() || flag) {
			...
			SmallDragonFireballEntity charge = new SmallDragonFireballEntity(GeoEntityRegistry.SMALL_DRAGON_FIREBALL,
			...
			playerIn.getCooldownTracker().setCooldown(this, 27);
