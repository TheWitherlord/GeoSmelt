...
public class GreaterIceTome extends Item {

	public GreaterIceTome(Properties properties) {
		super(properties);
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand hand) {
		...
		if (!itemstack.isEmpty() || flag) {
			...
			BigSnowballEntity charge = new BigSnowballEntity(GeoEntityRegistry.BIG_SNOWBALL,
			...
			playerIn.getCooldownTracker().setCooldown(this, 225);
