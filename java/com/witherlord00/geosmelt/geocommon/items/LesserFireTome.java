...
public class LesserFireTome extends Item {

	
	public LesserFireTome(Properties properties) {
		super(properties);
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand hand) {
		...
		if (!itemstack.isEmpty() || flag) {
			...
			SmallFireballEntity charge = new SmallFireballEntity(worldIn, playerIn, d2, d3, d4);
