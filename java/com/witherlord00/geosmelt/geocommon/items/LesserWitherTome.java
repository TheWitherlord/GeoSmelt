...
public class LesserWitherTome extends Item {

	
	public LesserWitherTome(Properties properties) { 
		super(properties);
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand hand) {
		...
		if (!itemstack.isEmpty() || flag) {
			...
			WitherSkullEntity charge = new WitherSkullEntity(worldIn, playerIn, d2, d3, d4);
			...
			playerIn.getCooldownTracker().setCooldown(this, 125);
